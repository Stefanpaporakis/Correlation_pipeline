...
plot_titles = ["30","35","37.3","48.3","52.3","55.9","59.2",
"62.1","64.7","67","68.9","74.5"]
percent = 20
crop = True
r_lower,r_upper = 0,2
...
for i, j in enumerate(dlist):
    #ax = axs[i/4,i%3] # all the plots (4 by 3)
   ...
   # ax.set_title(plot_titles[i]+chr(176),x = 0.5, y = 0.6)
plt.suptitle(analysis[:-4])

#plt.axvline(1.35, c = 'r', ls = '--')#,1.45)
#plt.axvline(1.45, c = 'r', ls = '--')#,1.45)
plt.show()
